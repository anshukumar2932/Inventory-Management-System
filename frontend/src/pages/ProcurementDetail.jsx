...
export default function ProcurementDetail() {
    ...
    useEffect(() => {
        async function fetchDetail() {
            ...
            try {
                const procurementRes = await apiGet(`${API}/procurements/${id}/`)
                ...
                const assetsRes = await apiGet(
                    `${ASSETS_API}/assets/?procurement_request=${procurementData.id}`
                )
                ...
                setAssets(toArrayResponse(assetsData))
            } catch (err) {
    ...
    const handleApprove = async () => {
        ...
        await apiPost(`${API}/procurements/${id}/approve/`, { remarks })
    ...
    const handleReject = async () => {
        ...
        setActionLoading(true)
        await apiPost(`${API}/procurements/${id}/reject/`, { remarks })
        setActionLoading(false)
        navigate("/procurements")
    }
    ...
    return (
        <>
            ...
            <div className="row g-3 mb-4">
                ...
                {(super_admin || dept_admin) && procurement.approval_status === "PENDING" && (
